...
const AutoplayAgent = preload("res://tests/rework/autoplay/autoplay_agent.gd")

var default_config_path := "res://tests/rework/autoplay/autoplay_basic.json"
var fallback_scene := "res://scenes/rework/main.tscn"
